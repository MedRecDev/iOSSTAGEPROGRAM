...
UIApplication.shared.sendAction(#selector(UIApplication.resignFirstResponder), to: nil, from: nil, for: nil)
       ...
       class func selectTime(title: String = "", userSelectedDate :String,
                                hideCancel: Bool = false,
                                datePickerMode: UIDatePicker.Mode = .date,
                                selectedDate: Date? = Date(),
                                minDate: Date? = nil,
    ...
    UIApplication.shared.sendAction(#selector(UIApplication.resignFirstResponder), to: nil, from: nil, for: nil)
                ...
                let currentDate = Date().dateString("YYYY-MM-dd")
...
//        let appDelegate = UIApplication.shared.windows.first .delegate as? AppDelegate
        return UIApplication.shared.windows.first?.currentController
    }
